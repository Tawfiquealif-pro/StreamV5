...
{title:"Squid-game-title.png",
poster:"Squid-game.jpg",
movieName:"Squid game",
name:"Squid game DUAL audio hevc, Hindi ,English",
source:"netflix", 
director:"Hwang Dong-hyuk",
writter:" Hwang Dong-hyuk",
cast:"Lee Jung-jae, Park Hae-soo, Wi Ha-jun",
rating:"8/10",
relese:"September 17, 2021 South Korea",
detailsSRC: 'Squid-game-DE.html',
background:"bg-Squid-game.jpg",
ageRestriction:"18+",
year:"2022",
genre:GENRE[16],
similarGenre1:GENRE[14] ,
similarGenre2:GENRE[3] ,
downloadlink:["https://mega.nz/folder/oJN31QAA#XtYKXv9fEYckLFykzLW9gA/folder/gYMT3Q5L"],
moreLink:0,
season:["season-1"],
duration:'10H 23min',
trailer:"y2mate.com - IVE 아이브 I AM MV_1440p.mp4",
...
function searchHandle(Path){
    if(Path === 'searchInputMobile'){
        searchBarToggleUp()
    }
    inputSearch = document.getElementById(Path).value;
...
document.getElementById("searchButton").addEventListener("click", function() {
    searchHandle("searchInputMobile"); // Calls with the value from the input field
});
...
function showContent(){
    ...
    document.getElementById('grid-container').innerHTML = `    <div class="grid1">
                <div class="titleShow">
                    <h4 id="getH4">Opps it Seems like We don't have <h2 id="contentName"></h2> </h4>
